 ...
 * {@code public}. Identical to the three earlier adopters' versions; the shared
 * {@code public.outbox_event} and {@code flyway_schema_history_outbox} mean
 * whichever service starts first migrates and the others see it already applied.
 */
@Configuration
